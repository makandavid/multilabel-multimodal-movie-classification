...
if __name__ == "__main__":
    ...
    text_val_features="data/processed/text_val_features.npy",
    image_val_features="data/processed/image_val_features.npy",
    labels_val="data/processed/y_val.npy",
    text_test_features="data/processed/text_test_features.npy",
    image_test_features="data/processed/image_test_features.npy",
